"""
MMSI MID (Maritime Identification Digits) to Flag State Lookup
The first 3 digits of an MMSI identify the vessel's flag state.
"""
...
MID_TO_COUNTRY = {
    ...
    "279": "Serbia", "301": "Anguilla", "303": "USA (Alaska)",
    ...
    "338": "USA", "339": "Jamaica", "341": "St. Kitts and Nevis",
    ...
    "359": "El Salvador", "361": "St. Pierre and Miquelon",
    ...
    "374": "Panama", "375": "St. Vincent and the Grenadines",
    ...
    "468": "Syria", "470": "UAE", "471": "UAE", "472": "Tajikistan",
    ...
    "578": "Wallis and Futuna", "601": "South Africa",
    "603": "Angola", "605": "Algeria", "607": "St. Paul and Amsterdam Islands",
    "608": "Ascension Island", "609": "Burundi", "610": "Benin",
    "611": "Botswana", "612": "Central African Republic",
    "613": "Cameroon", "615": "Congo", "616": "Comoros",
    "617": "Cape Verde", "618": "Crozet Archipelago",
    "619": "Ivory Coast", "620": "Comoros", "621": "Djibouti",
    "622": "Egypt", "624": "Ethiopia", "625": "Eritrea",
    "626": "Gabon", "627": "Ghana", "629": "Gambia",
    ...
    "679": "Zimbabwe", "701": "Argentina", "710": "Brazil",
    "720": "Bolivia", "725": "Chile", "730": "Colombia",
    "735": "Ecuador", "740": "Falkland Islands", "745": "Guiana",
    "750": "Guyana", "755": "Paraguay", "760": "Peru",
    "765": "Suriname", "770": "Uruguay", "775": "Venezuela"
}


def get_flag_state(mmsi):
    """
    Extract flag state from MMSI number.
    
    Args:
        mmsi: MMSI number (int or str)
    
    Returns:
        Country name (str) or None if not found
    """
    if mmsi is None:
        return None
